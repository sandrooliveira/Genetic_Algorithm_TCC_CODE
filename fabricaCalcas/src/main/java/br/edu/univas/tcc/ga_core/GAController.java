...
public class GAController {
	...
	public void classify(List<Individual> population){
		...
		//Remove todos os objetos com tempo < prazo da populaÁ„o
		population.removeAll(populationGood);
		
		//Adiciona-os na poplaÁ„o auxiliar
		populationAux.addAll(populationGood);
		
		//adiciona os demais indivÌduos da populaÁ„o
		populationAux.addAll(population);
		
		//Redefine a populaÁ„o
		population.clear();
